...
class createTweet(FlaskForm):
    tweet = TextAreaField(
        ...
        validators=[
            ...
            Length(
                max=500)])
    tweet_img = FileField('Include Image', validators=[
                          FileAllowed(['jpg', 'png'])])
    ...
    bio = StringField(
        ...
        validators=[
            Length(
                max=100),
            Optional()])
    profile = FileField('Update Profile Picture', validators=[
                        FileAllowed(['jpg', 'png'])])
    profile_bg = FileField('Upload background image', validators=[
                           FileAllowed(['jpg', 'png'])])
